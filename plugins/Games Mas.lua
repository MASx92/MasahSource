...
if msg.type ~= "pv" then
if MsgText[1] == "تفعيل" and MsgText[2] == "الالعاب" or MsgText[2] == "اللعبة" or MsgText[2] == "اللعبة" or MsgText[2] == "العاب ماسه" then
...
if MsgText[1] == "تعطيل" and MsgText[2] == "الالعاب" or MsgText[2] == "اللعبة" or MsgText[2] == "اللعبة" or MsgText[2] == "ماسه" then
if not msg.Admin then return "• ** هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n" end
...
t13 =[[
ماهو الشيء النبات ينبت للانسان فيا بذر؟
1-الاضافر 
2- الاسنان
3- الشعر
...
name = string.gsub(name,'قفي','الجار .... الدار')
...
if MsgText[1] == 'الالغاز' or MsgText[1] == 'لغز' then
  ...
  name = string.gsub(name,'الصوره','شيء يُؤخذ منك قفي أن يُعطى لك فما هو ؟')
...
name = string.gsub(name,'الغيم','ماهو الشي الذي يمشي فيا رجلين ويبكي فيا عيون؟')
...
name = string.gsub(name,'افي','تفاحة ماكول نصها وش هي؟')
name = string.gsub(name,'الصمت','ماهي الكلمة الذي يبطل معناها اذا نطقت بها؟ ')
...
name = string.gsub(name,'الصوت','اسير فيا رجلين ولا ادخل الا ب الاذنين؟')
...
name = string.gsub(name,'الجوال','يسمع فيا اذن ويحكي فيا لسان فما هو؟')
...
if MsgText[1] == 'المفتاح' or MsgText[1] == 'بات' then   
Num = math.random(1,6)
...
• اختر لأستخراج الالمفتاح أليد التي تحمل الالمفتاح 
...
katu = {'سحور','سياره','استقبال','قنفه','ايفون','بزونه','مطبخ','كرستيانو','دجاجه','مدرسه','الوان','غرفه','ثلاجه','قهوه','سفينه','العراق','محطه','طياره','رادار','منزل','مستشفى','كهرباء','تفاحه','اخطبوط','سلمون','فرنسا','برتقاله','تفاح','مطرقه','بتيته','لهانه','شباك','باص','سمكه','ذباب','ماسه','تلفاز','حاسوب','انترنيت','ساحه','جسر'};
name = katu[math.random(#katu)]
...
name = string.gsub(name,'ماسه','ك ر د و')
...
return '*• عدد النقاط التي ربحتها هي » { '..points..' }\n• تسطيع بيع نقاطك ولحصول على (100) رساله مقافي كل نقطه من النقاط *\n'
else
...
if MsgText[1] == "الالعاب" or MsgText[1] == "اللعبة" or MsgText[1] == "اللعبة" then
return [[ 
🤡│•⊱ الالعاب لبوت []]..redis:get(max..':NameBot:')..[[]  ، ! 🎖
⚙️│•⊱ لتفعيل الالعاب او تعطيلها ارسل
🎖│•⊱ تفعـيل ⊰• تعطيل •⊱ الالعاب
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
📜╿•⊱امثله ༜ لعبة امثلة قديمة
🎰│•⊱معاني ༜ كتابة اسم الايموجي
📋│•⊱اسئله ༜ لعبة اسئلة عامة
🎭│•⊱روليت ༜ لعبة الروليت الشهيرة
🤔│•⊱حزوره ༜ لعبة الحزورات
🎨│•⊱ترتيب ༜ لعبة ترتيب الكلمات
♻️│•⊱العكس ༜ لعبة عكس الكلمة
🎁│•⊱تخمين ༜ لعبة تخمين الكلمة
🤹‍♂│•⊱الاسرع ༜ لعبة اسرع واحد
👊│•⊱المفتاح ༜ اكتشف في اي يد المفتاح
🚦╽•⊱المختلف ༜ لعبة اختلاف الايموجي
🧮╽•⊱رياضيات ༜ لعبة مسائل حساب
🗽╽•⊱انقليزي ༜ لعبة ترجمة
🛠╽•⊱تفكيك ༜ لعبة تفكيك الكلمات
🐦╽•⊱كت تويت ༜ لعبة كت تويت الشهيرة
📝╽•⊱الالغاز ༜ لعبة الغاز
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
💬 │•⊱ للمزيد من المعلومات ،  ! 
...
if msg.text:match("^(%d+)$") and redis:get(max..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_) then  --// استقبال اللعبة الدمفيه
if msg.text == "1" then
Text = "*• * لا استطيع بدء اللعبة فياعب واحد فقط\n"
else
...
sendMsg(msg.chat_id_,msg.id_,'*• مبروك فزت وطلعت الالمفتاح في أليد رقم { '..NUM..' }\n• لقد حصلت على { 3 } من نقاط يمكنك استبدالها برسائل *')   
redis:incrby(max..':User_Points:'..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:del(max.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
sendMsg(msg.chat_id_,msg.id_,'\n*• للاسف لقد خسرت \n• الالمفتاح في أليد رقم { '..GETNUM..' }\n• حاول مره اخرى للعثور على الالمفتاح *')   
end
end
end
